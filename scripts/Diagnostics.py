	...
	def __init__(self, results_path=".", show=True):
		...
		self._plt.register_cmap(cmap=
			matplotlib.colors.LinearSegmentedColormap("smilei6", {
				'red'  :((0.0 , 0.001, 0.005), (0.0625 , 0.091, 0.091), (0.09375, 0.118, 0.118), (0.125 , 0.127, 0.127), (0.1875 , 0.135, 0.135), (0.21875, 0.125, 0.125), (0.28125, 0.034, 0.034), (0.3125 , 0.010, 0.010), (0.34375, 0.009, 0.009), (0.4375 , 0.049, 0.049), (0.46875, 0.057, 0.057), (0.5 , 0.058, 0.058), (0.59375, 0.031, 0.031), (0.625 , 0.028, 0.028), (0.65625, 0.047, 0.047), (0.71875, 0.143, 0.143), (0.78125, 0.294, 0.294), (0.84375, 0.519, 0.519), (0.90625, 0.664, 0.664), (0.9375 , 0.760, 0.760), (0.96875, 0.880, 0.880), (1., 1., 1. )),
				'green':((0.0, 0.010, 0.010), (0.21875, 0.228, 0.228), (0.78125, 0.827, 0.827), (0.8125 , 0.852, 0.852), (0.84375, 0.869, 0.869), (0.9375 , 0.937, 0.937), (0.96875, 0.967, 0.967), (1. , 1. , 1. )),
				'blue' :((0.0 , 0.010, 0.010), (0.0625 , 0.174, 0.184), (0.09375, 0.207, 0.207), (0.21875, 0.447, 0.447), (0.25 , 0.500, 0.500), (0.5 , 0.507, 0.507), (0.5625 , 0.502, 0.502), (0.625 , 0.485, 0.485), (0.6875 , 0.452, 0.452), (0.75 , 0.398, 0.398), (0.78125, 0.363, 0.363), (0.8125 , 0.345, 0.345), (0.84375, 0.377, 0.377), (0.90625, 0.534, 0.534), (0.9375 , 0.660, 0.660), (0.96875, 0.790, 0.790), (1. , 1. , 1. ))
				} , N=256, gamma=1.0)
		)
		self._plt.register_cmap(cmap=
			matplotlib.colors.LinearSegmentedColormap("smilei7", {
				'red'  :((0.0 , 0.026, 0.026), (0.09375, 0.077, 0.077), (0.1875 , 0.116, 0.116), (0.28125, 0.137, 0.137), (0.3125 , 0.136, 0.136), (0.375 , 0.121, 0.121), (0.40625, 0.132, 0.132), (0.5625 , 0.248, 0.248), (0.625 , 0.311, 0.311), (0.90625, 0.745, 0.745), (0.9375 , 0.805, 0.805), (0.96875, 0.880, 0.880), (1., 1., 1. )),
				'green':((0.0 , 0.037, 0.037), (0.125 , 0.149, 0.149), (0.28125, 0.278, 0.278), (0.71875, 0.693, 0.693), (0.9375 , 0.887, 0.887), (0.96875, 0.930, 0.930), (1., 1., 1. )),
				'blue' :((0.0 , 0.035, 0.035), (0.03125, 0.140, 0.140), (0.0625 , 0.220, 0.220), (0.09375, 0.278, 0.278), (0.3125 , 0.591, 0.591), (0.34375, 0.631, 0.631), (0.375 , 0.654, 0.654), (0.71875, 0.791, 0.791), (0.78125, 0.824, 0.824), (0.84375, 0.865, 0.865), (0.875 , 0.888, 0.888), (0.96875, 0.963, 0.963), (1., 1., 1. ))
				} , N=256, gamma=1.0)
		)
		self._plt.register_cmap(cmap=
			matplotlib.colors.LinearSegmentedColormap("smileiD1", {
				'red'  :((0.0 , 0.028, 0.028), (0.0625 , 0.027, 0.027), (0.109375, 0.049, 0.049), (0.1875 , 0.122, 0.122), (0.296875, 0.464, 0.464), (0.5 , 1. , 1. ), (0.546875, 0.942, 0.942), (0.609375, 0.816, 0.816), (0.71875 , 0.532, 0.532), (0.765625, 0.366, 0.366), (0.8125 , 0.187, 0.187), (0.84375 , 0.114, 0.114), (0.875 , 0.083, 0.083), (1.0 , 0.061, 0.061)),
				'green':((0.0 , 0.163, 0.163), (0.5 , 1. , 1. ), (0.546875, 0.936, 0.936), (0.625 , 0.805, 0.805), (0.78125 , 0.612, 0.612), (0.84375 , 0.517, 0.517), (1.0 , 0.251, 0.251)),
				'blue' :((0.0 , 0.328, 0.328), (0.078125, 0.525, 0.525), (0.25 , 0.668, 0.668), (0.3125 , 0.727, 0.727), (0.390625, 0.822, 0.822), (0.484375, 0.965, 0.965), (0.5 , 1. , 1. ), (0.515625, 0.962, 0.962), (0.75 , 0.187, 0.187), (0.765625, 0.157, 0.157), (0.78125 , 0.157, 0.157), (0.828125, 0.217, 0.217), (0.859375, 0.243, 0.243), (0.890625, 0.255, 0.255), (0.9375 , 0.254, 0.254), (1.0 , 0.232, 0.232)) 
				} , N=256, gamma=1.0)
		)
		self.reload()
