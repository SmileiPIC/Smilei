...
Ey = S.Field(0, "Et", theta=math.pi/2., timesteps=1000., subset={"x":[0,S.namelist.Main.grid_length[0]/4.],"y":[0,S.namelist.Main.grid_length[1]/2.]}).getData()[0]
Validate("Ey field at iteration 700", Ey, 0.01)

# COMPARE THE Jy FIELD in polarization direction
Jy = S.Field(0, "Jt", theta=math.pi/2., timesteps=1000., subset={"x":[0,S.namelist.Main.grid_length[0]/4.],"y":[0,S.namelist.Main.grid_length[1]/2.]}).getData()[0]
Validate("Jy field at iteration 700", Jy, 0.01)
