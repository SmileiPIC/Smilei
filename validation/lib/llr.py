...
def run_llr(command, dir, mode, options, parameters):
    ...
    with open(parameters['exec_script'], 'w') as exec_script_desc:
        ...
        exec_script_desc.write(
            ...
            +"module load hdf5/1.10.5-icc-omp2.1.6\n"
            +"module load python/3.7.0\n"
            +"module load h5py/hdf5_1.10.5-icc-omp2.1.6-py3.7.0\n"
            +"module load mpi4py/omp2.1.6-ib-icc_py3.7.0\n"
            +"module load compilers/gcc/4.9.2\n"
            +"module load fftw/3.3.10-omp-2.1.6-icc-19 \n"
            ...
            +"export FFTW3_LIB=/opt/exp_soft/vo.llr.in2p3.fr/fftw/3.3.10/opm-2.1.6-intel-19-el7/lib\n"
            +"export FFTW3_INC=/opt/exp_soft/vo.llr.in2p3.fr/fftw/3.3.10/opm-2.1.6-intel-19-el7/include\n"
            +"ulimit -s unlimited \n"
