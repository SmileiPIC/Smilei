...
void PusherBoris::operator()( Particles &particles, SmileiMPI *smpi, int istart, int iend, int ithread, int ipart_buffer_offset )
{
    ...
    double * __restrict invgf = &( smpi->dynamics_invgf[ithread][0] );
    ...
    double * __restrict position_x = particles.getPtrPosition(0);
    double * __restrict position_y = NULL;
    double * __restrict position_z = NULL;
    if (nDim_>1) {
    ...
    double * __restrict momentum_x = particles.getPtrMomentum(0);
    double * __restrict momentum_y = particles.getPtrMomentum(1);
    double * __restrict momentum_z = particles.getPtrMomentum(2);

    short * __restrict charge = particles.getPtrCharge();
