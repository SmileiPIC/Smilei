#ifndef PML_SOLVERAM_ENVELOPEREDUCEDDISPERSION_H
#define PML_SOLVERAM_ENVELOPEREDUCEDDISPERSION_H
...
//! Class Pusher
//  --------------------------------------------------------------------------------------------------------------------
class PML_SolverAM_EnvelopeReducedDispersion : public SolverAM
{

public:
    PML_SolverAM_EnvelopeReducedDispersion( Params &params );
    virtual ~PML_SolverAM_EnvelopeReducedDispersion();
