#ifndef PML_SOLVER2D_ENVELOPEREDUCEDDISPERSION_H
#define PML_SOLVER2D_ENVELOPEREDUCEDDISPERSION_H

#include "Solver2D.h"
class ElectroMagn;
class LaserEnvelope;

class PML_Solver2D_EnvelopeReducedDispersion : public Solver2D
{

public:
    PML_Solver2D_EnvelopeReducedDispersion( Params &params );
    virtual ~PML_Solver2D_EnvelopeReducedDispersion();
