...
void PML_SolverAM_EnvelopeReducedDispersion::compute_A_from_G( LaserEnvelope *envelope,int iDim, int min_or_max, unsigned int solvermin, unsigned int solvermax )
{
