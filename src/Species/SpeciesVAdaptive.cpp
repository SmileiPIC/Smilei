...
void SpeciesVAdaptive::resizeCluster( Params &params )
{
...
void SpeciesVAdaptive::importParticles( Params &params, Patch *patch, Particles &source_particles, vector<Diagnostic *> &localDiags )
{
...
void SpeciesVAdaptive::sort_part( Params &params )
{
    if( vectorized_operators ) {
...
//! This function reconfigures the operators
// -----------------------------------------------------------------------------
void SpeciesVAdaptive::reconfigure_particle_importation()
{
