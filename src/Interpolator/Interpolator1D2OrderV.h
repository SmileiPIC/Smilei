#ifndef INTERPOLATOR1D2ORDERV_H
#define INTERPOLATOR1D2ORDERV_H
...
//  --------------------------------------------------------------------------------------------------------------------
class Interpolator1D2OrderV final : public Interpolator1D
{

public:
    Interpolator1D2OrderV( Params &, Patch * );
    ~Interpolator1D2OrderV() override final {};
