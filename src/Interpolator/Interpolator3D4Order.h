...
private:
                        ...
                        double *coeffxd, double *coeffyd, double *coeffzd, double* delta_p )
    {
        ...
        // Declaration and calculation of the coefficient for interpolation
        double deltax, deltay, deltaz,delta2, delta3, delta4;
        ...
        delta3      = delta2*deltaz;
        delta4      = delta3*deltaz;
        coeffzd[0]  = dble_1_ov_384   - dble_1_ov_48  * deltaz  + dble_1_ov_16 * delta2 - dble_1_ov_12 * delta3 + dble_1_ov_24 * delta4;
        coeffzd[1]  = dble_19_ov_96   - dble_11_ov_24 * deltaz  + dble_1_ov_4 * delta2  + dble_1_ov_6  * delta3 - dble_1_ov_6  * delta4;
        coeffzd[2]  = dble_115_ov_192 - dble_5_ov_8   * delta2 + dble_1_ov_4 * delta4;
        coeffzd[3]  = dble_19_ov_96   + dble_11_ov_24 * deltaz  + dble_1_ov_4 * delta2  - dble_1_ov_6  * delta3 - dble_1_ov_6  * delta4;
        coeffzd[4]  = dble_1_ov_384   + dble_1_ov_48  * deltaz  + dble_1_ov_16 * delta2 + dble_1_ov_12 * delta3 + dble_1_ov_24 * delta4;
        
        delta_p[2]  = zpn - ( double )kp_;
