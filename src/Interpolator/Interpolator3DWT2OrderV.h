#ifndef INTERPOLATOR3DWT2ORDERV_H
#define INTERPOLATOR3DWT2ORDERV_H
...
//  --------------------------------------------------------------------------------------------------------------------
//! Class for vectorized 2nd order WT interpolator for 3d3v simulations
//  --------------------------------------------------------------------------------------------------------------------
class Interpolator3DWT2OrderV final : public Interpolator3DWT2Order
{

public:

    //! Creator for Interpolator3DWT2OrderV
    Interpolator3DWT2OrderV( Params &, Patch * );

    //! Destructor for Interpolator3DWT2OrderV
    ~Interpolator3DWT2OrderV() override final {};
