#ifndef InterpolatorAM1OrderRuytenV_H
#define InterpolatorAM1OrderRuytenV_H
...
//  --------------------------------------------------------------------------------------------------------------------
class InterpolatorAM1OrderRuytenV final : public InterpolatorAM
{

public:
    InterpolatorAM1OrderRuytenV( Params &, Patch * );
    ~InterpolatorAM1OrderRuytenV() override final {};
