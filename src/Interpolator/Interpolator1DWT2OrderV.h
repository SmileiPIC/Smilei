#ifndef INTERPOLATOR1DWT2ORDERV_H
#define INTERPOLATOR1DWT2ORDERV_H
...
//  --------------------------------------------------------------------------------------------------------------------
class Interpolator1DWT2OrderV final : public Interpolator1D
{

public:
    Interpolator1DWT2OrderV( Params &, Patch * );
    ~Interpolator1DWT2OrderV() override final {};
...
private:
    inline void coeffs( double xjn )
    {
        ...
        // 2nd WT order interpolation on 3 nodes
