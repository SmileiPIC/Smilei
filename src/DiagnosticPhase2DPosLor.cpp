...
DiagnosticPhase2DPosLor::DiagnosticPhase2DPosLor(phaseStructure phaseStruct, const unsigned int directionPosition) : 
...
void DiagnosticPhase2DPosLor::doSomething(partStruct& my_part) {
