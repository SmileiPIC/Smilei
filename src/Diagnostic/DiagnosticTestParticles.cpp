...
void DiagnosticTestParticles::run(int time) {
...
template <class T>
void DiagnosticTestParticles::append( hid_t fid, string name, std::vector<T> property, int nParticles, hid_t type, hsize_t * locator) {
