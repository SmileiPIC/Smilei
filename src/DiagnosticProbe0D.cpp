...
every(diagParams->probe0DStruc.size()),
smpi_(smpi),
probeSize(6),
fileId(0),
probeParticles(diagParams->probe0DStruc.size()),
probeId(diagParams->probe0DStruc.size())
{
...
void DiagnosticProbe0D::run(unsigned int np, ElectroMagn* EMfields, Interpolator* interp) {
