...
SimWindow::SimWindow( Params &params )
{
    ...
    if( PyTools::nComponents( "MovingWindow" ) ) {
        ...
        PyTools::extract( "time_start", time_start, "MovingWindow", 0, "a float" );
        PyTools::extract( "velocity_x", velocity_x, "MovingWindow", 0, "a float" );
        PyTools::extract( "number_of_additional_shifts", number_of_additional_shifts, "MovingWindow", 0, "an integer" );
        PyTools::extract( "additional_shifts_time", additional_shifts_time, "MovingWindow", 0, "a float" );
    }
