#ifndef IONIZATIONTUNNELENVELOPE_H
#define IONIZATIONTUNNELENVELOPE_H
...
class IonizationTunnelEnvelope : public Ionization
{

public:
    //! Constructor for IonizationTunnelEnvelope: with no input argument
    IonizationTunnelEnvelope( Params &params, Species *species );
