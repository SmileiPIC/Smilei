...
#ifndef FIELDSBC2D_Trans_SM_H
#define FIELDSBC2D_Trans_SM_H
...
class FieldsBC2D_Trans_SM : public FieldsBC {
public:
    FieldsBC2D_Trans_SM( PicParams &params, LaserParams &laser_params );
    ~FieldsBC2D_Trans_SM();
