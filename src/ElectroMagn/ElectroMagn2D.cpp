...
{    
    ...
    for (unsigned int ispec=0; ispec<n_species; ispec++) {
        Jx_s[ispec]  = new Field2D(("Jx_" +vecSpecies[ispec]->name).c_str(), dimPrim);
        Jy_s[ispec]  = new Field2D(("Jy_" +vecSpecies[ispec]->name).c_str(), dimPrim);
        Jz_s[ispec]  = new Field2D(("Jz_" +vecSpecies[ispec]->name).c_str(), dimPrim);
        rho_s[ispec] = new Field2D(("Rho_"+vecSpecies[ispec]->name).c_str(), dimPrim);
    }
