...
void ElectroMagn3D::initRelativisticPoissonFields(Patch *patch)
{
    ...
    By_rel_  = new Field3D(dimPrim, 1, false,  "By_rel"); // is equal to -beta*Ez, thus it inherits the same centering of Ez
    Bz_rel_  = new Field3D(dimPrim, 2, false,  "Bz_rel"); // is equal to  beta*Ey, thus it inherits the same centering of Ey
