    ...
    uses_numpy(false)
{
    ...
    // Otherwise (if the python profile cannot be hard-coded) ....
        ...
        if( try_numpy ) {
            ...
            if      ( nvariables_ == 1 ) ret = PyObject_CallFunctionObjArgs(py_profile, a, NULL);
            else if ( nvariables_ == 2 ) ret = PyObject_CallFunctionObjArgs(py_profile, a,a, NULL);
            else if ( nvariables_ == 3 ) ret = PyObject_CallFunctionObjArgs(py_profile, a,a,a, NULL);
            else if ( nvariables_ == 4 ) ret = PyObject_CallFunctionObjArgs(py_profile, a,a,a,a, NULL);
        ...
        if( !uses_numpy ) {
            ...
            PyObject* ret(nullptr);
            if      ( nvariables_ == 1 ) ret = PyObject_CallFunctionObjArgs(py_profile, z, NULL);
            else if ( nvariables_ == 2 ) ret = PyObject_CallFunctionObjArgs(py_profile, z,z, NULL);
            else if ( nvariables_ == 3 ) ret = PyObject_CallFunctionObjArgs(py_profile, z,z,z, NULL);
            else if ( nvariables_ == 4 ) ret = PyObject_CallFunctionObjArgs(py_profile, z,z,z,z, NULL);
            PyTools::checkPyError();
            Py_DECREF(z);
        ...
        if      ( nvariables_ == 1 ) function = new Function_Python1D(py_profile);
        else if ( nvariables_ == 2 ) function = new Function_Python2D(py_profile);
        else if ( nvariables_ == 3 ) function = new Function_Python3D(py_profile);
        else if ( nvariables_ == 4 ) function = new Function_Python4D(py_profile);
...
Profile::Profile(Profile *p){
  ...
  if( profileName != "" ) {
    ...
    if      ( nvariables_ == 1 ) function = new Function_Python1D(static_cast<Function_Python1D*>(p->function));
    else if ( nvariables_ == 2 ) function = new Function_Python2D(static_cast<Function_Python2D*>(p->function));
    else if ( nvariables_ == 3 ) function = new Function_Python3D(static_cast<Function_Python3D*>(p->function));
    else if ( nvariables_ == 4 ) function = new Function_Python4D(static_cast<Function_Python4D*>(p->function));
  }
}
