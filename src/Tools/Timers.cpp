...
Timers::Timers( SmileiMPI * smpi ) :
    ...
    injectPart  ("Inject Particles"), // Call exchangeParticles (MPI & Patch sync)
    ...
    syncDensY  ("NULL")  // If necessary the following timers can be reintroduced
{
    timers.resize(0);
