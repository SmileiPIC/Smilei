...
{
    // initiliaze values for the Inverse error function
    erfinv_needLoad_ = true;
...
// ------------------------------------------
void tabulatedFunctions::erfinv_loadTab() {
...
double tabulatedFunctions::erfinv(double x) {
    ...
    else if (x >= erfinv_x_[erfinv_tabSize_-1]) {
