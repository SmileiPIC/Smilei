...
public:
    ...
    // Project susceptibility
    void susceptibilityOnBuffer( ElectroMagn *EMfields, double *b_ChiAM, int bin_shift, Particles &particles, double species_mass, SmileiMPI *smpi, int istart, int iend,  int ithread, int icell = 0, int ipart_ref = 0 ) override final;
