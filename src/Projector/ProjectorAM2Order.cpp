...
// Projector for susceptibility used as source term in envelope equation
void ProjectorAM2Order::susceptibilityOnAMBuffer( ElectroMagn *EMfields, std::complex<double> *b_ChiAM, int bin_shift, int bdim0, Particles &particles, double species_mass, SmileiMPI *smpi, int istart, int iend,  int ithread, int icell, int ipart_ref )
{
    // -------------------------------------
    // Variable declaration & initialization
    // -------------------------------------
