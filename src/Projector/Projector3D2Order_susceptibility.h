...
public:
    ...
    //void project_susceptibility(double* Chi_envelope, Particles &particles, unsigned int bin, std::vector<unsigned int> &b_dim, SmileiMPI* smpi, int ithread,int istart, int iend, double species_mass);
    void project_susceptibility(double* Chi_envelope, Particles &particles, unsigned int bin, std::vector<unsigned int> &b_dim, SmileiMPI* smpi, int ithread,int istart, int iend, double species_mass);
