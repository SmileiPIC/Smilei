...
// ---------------------------------------------------------------------------------------------------------------------
void Projector3D4Order::operator() (double* rho, double* Jx, double* Jy, double* Jz, Particles &particles, unsigned int ipart, unsigned int bin, std::vector<unsigned int> &b_dim)
{
