...
//#endif
            ...
            for( unsigned int particle_index = first_particle + thread_index_offset;
                ...
                //i=0
                    for( unsigned int k = 0; k < 5; ++k ) {
                        ComputeFloat tmp = cry_p * (    
                                                     + static_cast<ComputeFloat>( 0.5 )     * ( ( Sx1[0] )*Sz0[k] ) 
                                                     +                           one_third  *   ( Sx1[0] )    *     ( Sz1[k] - Sz0[k] ) );
                        ComputeFloat tmp_reduction{};
                ...
                //i=4
                    for( unsigned int k = 0; k < 5; ++k ) {
                        ComputeFloat tmp = cry_p * (                 
                                                     + static_cast<ComputeFloat>( 0.5 )     * ( ( Sx1[4] )*Sz0[k] ) 
                                                     +                           one_third  *   ( Sx1[4] )    *     ( Sz1[k] - Sz0[k] ) );
                        ComputeFloat tmp_reduction{};
                ...
                //i=0
                    ...
                    for( unsigned int j = 1; j < 4; ++j ) {
                        ComputeFloat tmp = crz_p * (                 
                                                     + static_cast<ComputeFloat>( 0.5 )     * ( ( Sx1[0]          )*Sy0[j-1]                              ) 
                                                     +                           one_third  *   ( Sx1[0]          )    *     ( Sy1[j] - Sy0[j-1] ) );
                        ComputeFloat tmp_reduction{};
                ...
                //i=4
                    ...
                    for( unsigned int j = 1; j < 4; ++j ) {
                        ComputeFloat tmp = crz_p * (                 
                                                     + static_cast<ComputeFloat>( 0.5 )     * ( ( Sx1[4]          )*Sy0[j-1]                              ) 
                                                     +                           one_third  *   ( Sx1[4]          )    *     ( Sy1[j] - Sy0[j-1] ) );
                        ComputeFloat tmp_reduction{};
