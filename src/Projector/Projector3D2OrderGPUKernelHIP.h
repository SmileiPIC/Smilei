...
//#endif
            ...
            for( unsigned int particle_index = first_particle + thread_index_offset;
                ...
                //k = 0 
                {
                    ...
                    const unsigned int jk_loc = ( ipo * GPUClusterWithGCWidth + jpo     ) * GPUClusterWithGCWidth + kpo;
                    tmp_reduction -= Sx1[0] * tmp; //i=1
                    unsigned int loc = GPUClusterWithGCWidth*GPUClusterWithGCWidth + jk_loc;
                ...
                for( unsigned int k = 1; k < 4; ++k ) {
                    ...
                    ComputeFloat tmp_reduction{};
                    const unsigned int jk_loc = ( ipo * GPUClusterWithGCWidth + jpo     ) * GPUClusterWithGCWidth + kpo + k;
                    tmp_reduction -= Sx1[0] * tmp; //i=1
                    unsigned int loc = GPUClusterWithGCWidth*GPUClusterWithGCWidth + jk_loc;
                    atomic::LDS::AddNoReturn( &Jx_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                    for( unsigned int i = 2; i < 5; ++i ) {
                ...
                //k = 4
                {
                    ComputeFloat tmp = crx_p * one_third * Sy1[0]* Sz1[4];
                    ComputeFloat tmp_reduction{};
                    const unsigned int jk_loc = ( ipo * GPUClusterWithGCWidth + jpo     ) * GPUClusterWithGCWidth + kpo + 4;
                    tmp_reduction -= Sx1[0] * tmp; //i=1
                    unsigned int loc = GPUClusterWithGCWidth*GPUClusterWithGCWidth + jk_loc;
                    atomic::LDS::AddNoReturn( &Jx_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                    for( unsigned int i = 2; i < 5; ++i ) {
                ...
                for( unsigned int j = 1; j < 4; ++j ) { 
                    //k=0
                    {
                        ...
                        ComputeFloat tmp_reduction{};
                        const unsigned int jk_loc = ( ipo * GPUClusterWithGCWidth + jpo + j ) * GPUClusterWithGCWidth + kpo;
                        tmp_reduction -= Sx1[0] * tmp; //i=1
                        unsigned int loc = GPUClusterWithGCWidth*GPUClusterWithGCWidth + jk_loc;
                        atomic::LDS::AddNoReturn( &Jx_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                        for( unsigned int i = 2; i < 5; ++i ) {
                    ...
                    for( unsigned int k = 1; k < 4; ++k ) {
                        ...
                        ComputeFloat tmp_reduction{};
                        const unsigned int jk_loc = ( ipo * GPUClusterWithGCWidth + jpo + j ) * GPUClusterWithGCWidth + kpo + k;
                        tmp_reduction -= Sx1[0] * tmp; //i=1
                        unsigned int loc = GPUClusterWithGCWidth*GPUClusterWithGCWidth + jk_loc;
                        atomic::LDS::AddNoReturn( &Jx_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                        for( unsigned int i = 2; i < 5; ++i ) {
                    ...
                    //k=4
                    {
                        ComputeFloat tmp = crx_p * Sz1[4] * ( static_cast<ComputeFloat>( 0.5 ) * Sy0[j-1]
                                       + one_third * ( Sy1[j] - Sy0[j-1] ) );
                        ComputeFloat tmp_reduction{};
                        const unsigned int jk_loc = ( ipo * GPUClusterWithGCWidth + jpo + j ) * GPUClusterWithGCWidth + kpo + 4;
                        tmp_reduction -= Sx1[0] * tmp; //i=1
                        unsigned int loc = GPUClusterWithGCWidth*GPUClusterWithGCWidth + jk_loc;
                        atomic::LDS::AddNoReturn( &Jx_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                        for( unsigned int i = 2; i < 5; ++i ) {
                ...
                //k=0
                {
                    ...
                    ComputeFloat tmp_reduction{};
                    const unsigned int jk_loc = ( ipo * GPUClusterWithGCWidth + jpo + 4 ) * GPUClusterWithGCWidth + kpo;
                    tmp_reduction -= Sx1[0] * tmp; //i=1
                    unsigned int loc = GPUClusterWithGCWidth*GPUClusterWithGCWidth + jk_loc;
                    atomic::LDS::AddNoReturn( &Jx_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                    for( unsigned int i = 2; i < 5; ++i ) {
                ...
                for( unsigned int k = 1; k < 4; ++k ) {
                    ComputeFloat tmp = crx_p * Sy1[4] * ( static_cast<ComputeFloat>( 0.5 ) * Sz0[k-1] 
                                        + one_third * ( Sz1[k] - Sz0[k-1] ) );
                    ComputeFloat tmp_reduction{};
                    const unsigned int jk_loc = ( ipo * GPUClusterWithGCWidth + jpo + 4 ) * GPUClusterWithGCWidth + kpo + k;
                    tmp_reduction -= Sx1[0] * tmp; //i=1
                    unsigned int loc = GPUClusterWithGCWidth*GPUClusterWithGCWidth + jk_loc;
                    atomic::LDS::AddNoReturn( &Jx_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                //k=4
                {
                    ComputeFloat tmp = crx_p * one_third * Sy1[4] * Sz1[4];
                    ComputeFloat tmp_reduction{};
                    const unsigned int jk_loc = ( ipo * GPUClusterWithGCWidth + jpo + 4 ) * GPUClusterWithGCWidth + kpo + 4;
                    tmp_reduction -= Sx1[0] * tmp; //i=1
                    unsigned int loc = GPUClusterWithGCWidth*GPUClusterWithGCWidth + jk_loc;
                    atomic::LDS::AddNoReturn( &Jx_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                    for( unsigned int i = 2; i < 5; ++i ) {
                ...
                //k=0
                {
                    ...
                    ComputeFloat tmp_reduction{};
                    const unsigned int ik_loc = ((     ipo ) * GPUClusterWithGCWidth + jpo ) * GPUClusterWithGCWidth + kpo;
                    //j=1
                    tmp_reduction -= Sy1[0] * tmp;
                    unsigned int loc =  GPUClusterWithGCWidth + ik_loc;
                ...
                for( unsigned int k = 1; k < 4; ++k ) {
                    ComputeFloat tmp = cry_p  * Sx1[0] * ( static_cast<ComputeFloat>( 0.5 ) * Sz0[k-1] 
                                                + one_third * ( Sz1[k] - Sz0[k-1] ) );
                    ComputeFloat tmp_reduction{};
                    const unsigned int ik_loc = ((     ipo ) * GPUClusterWithGCWidth + jpo ) * GPUClusterWithGCWidth + kpo + k;
                    //j=1
                    tmp_reduction -= Sy1[0] * tmp;
                    unsigned int loc =  GPUClusterWithGCWidth + ik_loc;
                    atomic::LDS::AddNoReturn( &Jy_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                //k=4
                {
                    ComputeFloat tmp = cry_p * one_third * Sx1[0] * Sz1[4] ;
                    ComputeFloat tmp_reduction{};
                    const unsigned int ik_loc = ((     ipo ) * GPUClusterWithGCWidth + jpo ) * GPUClusterWithGCWidth + kpo + 4;
                ...
                for( unsigned int i = 1; i < 4; ++i ) {
                    //k=0
                    {
                        ...
                        ComputeFloat tmp_reduction{};
                        const unsigned int ik_loc = (( i + ipo ) * GPUClusterWithGCWidth + jpo ) * GPUClusterWithGCWidth + kpo;
                        tmp_reduction -= Sy1[0] * tmp; //j=1
                        unsigned int loc =  GPUClusterWithGCWidth + ik_loc;
                        atomic::LDS::AddNoReturn( &Jy_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                        for( unsigned int j = 2; j < 5; ++j ) {
                    ...
                    for( unsigned int k = 1; k < 4; ++k ) {
                        ...
                        ComputeFloat tmp_reduction{};
                        const unsigned int ik_loc = (( i + ipo ) * GPUClusterWithGCWidth + jpo ) * GPUClusterWithGCWidth + kpo + k;
                        tmp_reduction -= Sy1[0] * tmp; //j=1
                        unsigned int loc =  GPUClusterWithGCWidth + ik_loc;
                        atomic::LDS::AddNoReturn( &Jy_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                        for( unsigned int j = 2; j < 5; ++j ) {
                    ...
                    //k=4
                    {   
                        ComputeFloat tmp = cry_p * Sz1[4] * ( static_cast<ComputeFloat>( 0.5 ) * Sx0[i-1] + one_third * ( Sx1[i] - Sx0[i-1] ) );
                        ComputeFloat tmp_reduction{};
                        const unsigned int ik_loc = (( i + ipo ) * GPUClusterWithGCWidth + jpo ) * GPUClusterWithGCWidth + kpo + 4;
                        //j=1
                        tmp_reduction -= Sy1[0] * tmp;
                        unsigned int loc =  GPUClusterWithGCWidth + ik_loc;
                        atomic::LDS::AddNoReturn( &Jy_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                //k=0
                {
                    ...
                    ComputeFloat tmp_reduction{};
                    const unsigned int ik_loc = (( 4 + ipo ) * GPUClusterWithGCWidth + jpo ) * GPUClusterWithGCWidth + kpo;
                    //j=1
                    tmp_reduction -= Sy1[0] * tmp;
                    unsigned int loc =  GPUClusterWithGCWidth + ik_loc;
                    atomic::LDS::AddNoReturn( &Jy_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                for( unsigned int k = 1; k < 4; ++k ) {
                    ComputeFloat tmp = cry_p * Sx1[4] * ( static_cast<ComputeFloat>( 0.5 ) * Sz0[k-1] 
                                                    + one_third * ( Sz1[k] - Sz0[k-1] ) );
                    ComputeFloat tmp_reduction{};
                    const unsigned int ik_loc = (( 4 + ipo ) * GPUClusterWithGCWidth + jpo ) * GPUClusterWithGCWidth + kpo + k;
                    //j=1
                    tmp_reduction -= Sy1[0] * tmp;
                    unsigned int loc =  GPUClusterWithGCWidth + ik_loc;
                    atomic::LDS::AddNoReturn( &Jy_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                //k=4
                {
                    ComputeFloat tmp = cry_p * one_third * Sx1[4] * Sz1[4] ;
                    ComputeFloat tmp_reduction{};
                    const unsigned int ik_loc = (( 4 + ipo ) * GPUClusterWithGCWidth + jpo ) * GPUClusterWithGCWidth + kpo + 4;
                    //j=1
                    tmp_reduction -= Sy1[0] * tmp;
                    unsigned int loc =  GPUClusterWithGCWidth + ik_loc;
                    atomic::LDS::AddNoReturn( &Jy_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                
                {
                    ...
                    ComputeFloat tmp_reduction{};
                    const unsigned int ij_loc = ((     ipo ) * GPUClusterWithGCWidth + (jpo    )) * GPUClusterWithGCWidth + kpo;
                    {
                        tmp_reduction -= Sz1[0] * tmp; // k=1
                        const unsigned int loc = 1 + ij_loc;
                    ...
                    for( unsigned int k = 2; k < 5; ++k ) {
                        ...
                        const unsigned int loc = k + ij_loc;
                        atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                    }
                }
                //i=0 & j=1,3
                for( unsigned int j = 1; j < 4; ++j ) {
                    ComputeFloat tmp = crz_p * Sx1[0] * ( static_cast<ComputeFloat>( 0.5 ) * Sy0[j-1] 
                                                    + one_third * ( Sy1[j] - Sy0[j-1] ) );
                    ComputeFloat tmp_reduction{};
                    const unsigned int ij_loc = ((     ipo ) * GPUClusterWithGCWidth + (jpo + j)) * GPUClusterWithGCWidth + kpo;
                    {
                        tmp_reduction -= Sz1[0] * tmp;// k=1
                        const unsigned int loc = 1 + ij_loc;
                        atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                //i=0 & j=4
                {
                    ...
                    ComputeFloat tmp_reduction{};
                    const int unsigned ij_loc = ((     ipo ) * GPUClusterWithGCWidth + (jpo + 4 )) * GPUClusterWithGCWidth + kpo;
                    {
                        tmp_reduction -= Sz1[0]* tmp;// k=1
                        const int unsigned loc = 1 + ij_loc;
                        atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                    }
                    for( unsigned int k = 2; k < 5; ++k ) {
                        tmp_reduction -= ( Sz1[k-1] - Sz0[k-2] ) * tmp;
                        const int unsigned loc = k + ij_loc;
                        atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                    }
                }
                ...
                for( unsigned int i = 1; i < 4; ++i ) {
                    //j=0
                    {
                        ComputeFloat tmp = crz_p * Sy1[0] * ( static_cast<ComputeFloat>( 0.5 ) * Sx0[i-1]
                                                  + one_third * ( Sx1[i] - Sx0[i-1] ) );
                        ComputeFloat tmp_reduction{};
                        const unsigned int ij_loc = (( i + ipo ) * GPUClusterWithGCWidth + (jpo    )) * GPUClusterWithGCWidth + kpo;
                        {
                            tmp_reduction -= Sz1[0] * tmp;// k=1
                            const unsigned int loc =  1  + ij_loc;
                            atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                    ...
                    for( unsigned int j = 1; j < 4; ++j ) {
                        ...
                        ComputeFloat tmp_reduction{};
                        const unsigned int ij_loc = (( i + ipo ) * GPUClusterWithGCWidth + (jpo + j)) * GPUClusterWithGCWidth + kpo;
                        {
                            tmp_reduction -= Sz1[0] * tmp;// k=1
                            const unsigned int loc =  1  + ij_loc;
                            atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                    ...
                    //j=4
                    {
                        ComputeFloat tmp = crz_p * Sy1[4] * ( static_cast<ComputeFloat>( 0.5 ) * Sx0[i-1] 
                                                     + one_third * ( Sx1[i] - Sx0[i-1] ) );
                        ComputeFloat tmp_reduction{};
                        const unsigned int ij_loc = (( i + ipo ) * GPUClusterWithGCWidth + (jpo + 4 )) * GPUClusterWithGCWidth + kpo;
                        {
                            tmp_reduction -= Sz1[0] * tmp;// k=1
                            const unsigned int loc =  1  + ij_loc;
                            atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                //j=0
                {
                    ...
                    ComputeFloat tmp_reduction{};
                    const unsigned int ij_loc = ((  4 + ipo ) * GPUClusterWithGCWidth + (jpo    )) * GPUClusterWithGCWidth + kpo;
                    {
                        tmp_reduction -= Sz1[0]* tmp;// k=1
                        const unsigned int loc =  1  + ij_loc;
                        atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                for( unsigned int j = 1; j < 4; ++j ) {
                    ComputeFloat tmp = crz_p * Sx1[4] * ( static_cast<ComputeFloat>( 0.5 ) * Sy0[j-1]
                                                    + one_third * ( Sy1[j] - Sy0[j-1] ) );
                    ComputeFloat tmp_reduction{};
                    const unsigned int ij_loc = ((  4 + ipo ) * GPUClusterWithGCWidth + (jpo + j)) * GPUClusterWithGCWidth + kpo;
                    {
                        tmp_reduction -= Sz1[0]* tmp;// k=1
                        const unsigned int loc =  1  + ij_loc;
                        atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
                ...
                //j=4
                {
                    ...
                    ComputeFloat tmp_reduction{};
                    const unsigned int ij_loc = ((  4 + ipo ) * GPUClusterWithGCWidth + (jpo + 4 )) * GPUClusterWithGCWidth + kpo;
                    {
                        tmp_reduction -= Sz1[0]* tmp;// k=1
                        const unsigned int loc =  1  + ij_loc;
                        atomic::LDS::AddNoReturn( &Jz_scratch_space[loc], static_cast<ReductionFloat>( tmp_reduction ) );
