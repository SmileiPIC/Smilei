...
public:
    ...
    inline void currents( ElectroMagnAM *emAM, Particles &particles, unsigned int ipart, double invgf, int *iold, double *deltaold, double *array_theta_old, int imode );
    ...
    //! Project global current densities (EMfields->Jl_/Jr_/Jt_/rho), diagFields timestep
    inline void currentsAndDensity( std::complex<double> *Jl, std::complex<double> *Jr, std::complex<double> *Jt, std::complex<double> *rho, Particles &particles, unsigned int ipart, double invgf, int *iold, double *deltaold, double *array_theta_old,  int imode );
