    ...
    bool diag_flag )
{
    ...
    #pragma acc loop gang worker vector
        ...
        const double dx_ov_dt__inv_cell_volume = dx_ov_dt * inv_cell_volume;
    ...
    #pragma acc loop gang worker
        ...
        for( int ipart=istart_pack ; ipart<iend_pack; ipart++ ) {
            ...
            const double crx_p = dx_ov_dt__inv_cell_volume * static_cast<double>( charge[ipart] ) * weight[ipart];
    ...
    #pragma acc loop gang worker vector
        ...
        const double dy_ov_dt__inv_cell_volume = dy_ov_dt * inv_cell_volume;
    ...
    #pragma acc loop gang worker
        ...
        for( int ipart=istart_pack ; ipart<iend_pack; ipart++ ) {
            ...
            const double cry_p = dy_ov_dt__inv_cell_volume * static_cast<double>( charge[ipart] ) * weight[ipart];
    ...
    #pragma acc loop gang worker vector
        ...
        const double dz_ov_dt__inv_cell_volume = dz_ov_dt * inv_cell_volume;
    ...
    #pragma acc loop gang worker
        ...
        for( int ipart=istart_pack ; ipart<iend_pack; ipart++ ) {
            ...
            const double crz_p = dz_ov_dt__inv_cell_volume * static_cast<double>( charge[ipart] ) * weight[ipart];
