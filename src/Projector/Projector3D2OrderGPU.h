...
public:
    ...
    inline void currentsAndDensityGPU( ElectroMagn *EMfields, Particles &particles, int istart, int iend, double *invgf, int *iold, double *deltaold, bool diag_flag = false );
