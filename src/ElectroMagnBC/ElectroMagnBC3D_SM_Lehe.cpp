...
ElectroMagnBC3D_SM_Lehe::ElectroMagnBC3D_SM_Lehe( Params &params, Patch* patch, unsigned int _min_max )
...
ElectroMagnBC3D_SM_Lehe::~ElectroMagnBC3D_SM_Lehe()
{
...
void ElectroMagnBC3D_SM_Lehe::save_fields(Field* my_field, Patch* patch) {
...
void ElectroMagnBC3D_SM_Lehe::disableExternalFields()
{
    delete Bx_val;
    Bx_val = NULL;
    delete By_val;
...
// ---------------------------------------------------------------------------------------------------------------------
void ElectroMagnBC3D_SM_Lehe::apply(ElectroMagn* EMfields, double time_dual, Patch* patch)
{
    if ( min_max==0 && patch->isXmin() ) {
