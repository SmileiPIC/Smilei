...
#ifndef ELECTROMAGNBC3D_SM_LEHE_H
#define ELECTROMAGNBC3D_SM_LEHE_H
...
class ElectroMagnBC3D_SM_Lehe : public ElectroMagnBC {
public:

    ElectroMagnBC3D_SM_Lehe( Params &params, Patch* patch, unsigned int _min_max );
    ~ElectroMagnBC3D_SM_Lehe();
