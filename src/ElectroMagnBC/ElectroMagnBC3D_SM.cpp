        ...
        for (unsigned int j=0 ; j<ny_p ; j++) {
            ...
            for (unsigned int k=0 ; k<nz_d ; k++) {
                ...
                (*By3D)(0,j,k) = Alpha_SM_W   *   (*Ez3D)(0,j  ,k)
                    +            Beta_SM_W    * ( (*By3D)(1,j  ,k) )
                    +            Gamma_SM_W   * byW
                    +            Delta_SM_W   * ( (*Bx3D)(0,j+1,k) )
                    +            Epsilon_SM_W * ( (*Bx3D)(0,j  ,k) );
            }// k  ---end compute By
        }//j  ---end compute By
         ...
         for (unsigned int j=0 ; j<ny_d ; j++) {
            ...
            for (unsigned int k=0 ; k<nz_p ; k++) {
                ...
                (*Bz3D)(0,j,k) = - Alpha_SM_W *   (*Ey3D)(0,j,k)
                    +              Beta_SM_W  * ( (*Bz3D)(1,j,k  ) )
                    +              Gamma_SM_W * bzW
                    +              Zeta_SM_W  * ( (*Bx3D)(0,j,k+1) )
                    +              Eta_SM_W   * ( (*Bx3D)(0,j,k  ) );
        ...
        for (unsigned int j=0 ; j<ny_p ; j++) {
            ...
            for (unsigned int k=0 ; k<nz_d ; k++) {
                ...
                (*By3D)(nx_d-1,j,k) = Alpha_SM_E   *   (*Ez3D)(nx_p-1,j,  k)
                    +                 Beta_SM_E    * ( (*By3D)(nx_d-2,j,  k) )
                    +                 Gamma_SM_E   * byE
                    +                 Delta_SM_E   * ( (*Bx3D)(nx_p-1,j+1,k) )
                    +                 Epsilon_SM_E * ( (*Bx3D)(nx_p-1,j,  k) );
        ...
        for (unsigned int j=0 ; j<ny_d; j++) {
            ...
            for (unsigned int k=0 ; k<nz_p ; k++) {
                ...
                (*Bz3D)(nx_d-1,j,k) = -Alpha_SM_E *   (*Ey3D)(nx_p-1,j,k  )
                    +                  Beta_SM_E  * ( (*Bz3D)(nx_d-2,j,k  ) )
                    +                  Gamma_SM_E * bzE
                    +                  Zeta_SM_E  * ( (*Bx3D)(nx_p-1,j,k+1) )
                    +                  Eta_SM_E   * ( (*Bx3D)(nx_p-1,j,k  ) );
            }//k  ---end compute Bz
        }//j  ---end compute Bz
    }
    else if (min_max==2 && patch->isYmin() ) {
        ...
        for (unsigned int i=0 ; i<nx_p ; i++) {
            for (unsigned int k=0 ; k<nz_d ; k++) {  
                (*Bx3D)(i,0,k) = - Alpha_SM_S *   (*Ez3D)(i,  0,k)
                    +              Beta_SM_S  * ( (*Bx3D)(i,  1,k) )
                    +              Zeta_SM_S  * ( (*By3D)(i+1,0,k) )
                    +              Eta_SM_S   * ( (*By3D)(i,  0,k) );
            }// k  ---end compute Bx
        }//i  ---end compute Bx
        ...
        for (unsigned int i=0 ; i<nx_d ; i++) {
            for (unsigned int k=0 ; k<nz_p ; k++) {  
                (*Bz3D)(i,0,k) = Alpha_SM_S   *   (*Ex3D)(i,0,k  )
                    +            Beta_SM_S    * ( (*Bz3D)(i,1,k  ) )
                    +            Delta_SM_S   * ( (*By3D)(i,0,k+1) )
                    +            Epsilon_SM_S * ( (*By3D)(i,0,k  ) );
            }// k  ---end compute Bz
        }//i  ---end compute Bz       }
    }
    else if (min_max==3 && patch->isYmax() ) {
        ...
        for (unsigned int i=0 ; i<nx_p ; i++) {
            for (unsigned int k=0 ; k<nz_d ; k++) {
                ...
                (*Bx3D)(i,ny_d-1,k) = -Alpha_SM_N *  (*Ez3D)(i,  ny_p-1,k)
                    +                  Beta_SM_N  *( (*Bx3D)(i,  ny_d-2,k) )
                    +                  Zeta_SM_N  *( (*By3D)(i+1,ny_p-1,k) )
                    +                  Eta_SM_N   *( (*By3D)(i,  ny_p-1,k) );
        ...
        for (unsigned int i=0 ; i<nx_d ; i++) {
            for (unsigned int k=0 ; k<nz_p ; k++) {
                ...
                (*Bz3D)(i,ny_d-1,k) = Alpha_SM_N   *   (*Ex3D)(i,ny_p-1,k  )
                    +                 Beta_SM_N    * ( (*Bz3D)(i,ny_d-2,k  ) )
                    +                 Delta_SM_N   * ( (*By3D)(i,ny_p-1,k+1) )
                    +                 Epsilon_SM_N * ( (*By3D)(i,ny_p-1,k  ) );
        ...
        for (unsigned int i=0 ; i<nx_p ; i++) {
            for (unsigned int j=0 ; j<ny_d ; j++) {
                ...
                (*Bx3D)(i,j,0) = Alpha_SM_B   *   (*Ey3D)(i,j  ,0)
                    +            Beta_SM_B    * ( (*Bx3D)(i,  j,1) )
                    +            Delta_SM_B   * ( (*Bz3D)(i+1,j,0) )
                    +            Epsilon_SM_B * ( (*Bz3D)(i,  j,0) );
            }// j  ---end compute Bx
        }//i  ---end compute Bx
        ...
        for (unsigned int i=0 ; i<nx_d ; i++) {
            for (unsigned int j=0 ; j<ny_p ; j++) {
                ...
                (*By3D)(i,j,0) = - Alpha_SM_B *   (*Ex3D)(i,j,  0)
                    +              Beta_SM_B  * ( (*By3D)(i,j,  1) )
                    +              Zeta_SM_B  * ( (*Bz3D)(i,j+1,0) )
                    +              Eta_SM_B   * ( (*Bz3D)(i,j,  0) );
        ...
        for (unsigned int i=0 ; i<nx_p ; i++) {
            for (unsigned int j=0 ; j<ny_d ; j++) {
                ...
                (*Bx3D)(i,j,nz_d-1) = Alpha_SM_T   *   (*Ey3D)(i,  j,nz_p-1)
                    +                 Beta_SM_T    * ( (*Bx3D)(i,  j,nz_d-2) )
                    +                 Delta_SM_T   * ( (*Bz3D)(i+1,j,nz_p-1) )
                    +                 Epsilon_SM_T * ( (*Bz3D)(i,  j,nz_p-1) );
        ...
        for (unsigned int i=0 ; i<nx_d ; i++) {
            for (unsigned int j=0 ; j<ny_p ; j++) {
                ...
                (*By3D)(i,j,nz_d-1) = -Alpha_SM_T *   (*Ex3D)(i,j,  nz_p-1)
                    +                  Beta_SM_T  * ( (*By3D)(i,j,  nz_d-2) )
                    +                  Zeta_SM_T  * ( (*Bz3D)(i,j+1,nz_p-1) )
                    +                  Eta_SM_T   * ( (*Bz3D)(i,j,  nz_p-1) );
