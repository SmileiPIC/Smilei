...
void Domain::init_pxr(Params &params)
{
    ...
    if(cdim==2) {
      ...
      Field2D* Ex2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->Ex_pxr);
      Field2D* Ey2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->Ey_pxr);
      Field2D* Ez2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->Ez_pxr);
      Field2D* Bx2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->Bx_pxr);
      Field2D* By2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->By_pxr);
      Field2D* Bz2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->Bz_pxr);
      Field2D* Jx2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->Jx_pxr);
      Field2D* Jy2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->Jy_pxr);
      Field2D* Jz2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->Jz_pxr);
      Field2D* rho2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->rho_pxr);
      Field2D* rhoold2D_pxr = static_cast<Field2D*>(this->vecPatch_(0)->EMfields->rhoold_pxr);
      init_params_picsar(&n0,&n1,&n2,
