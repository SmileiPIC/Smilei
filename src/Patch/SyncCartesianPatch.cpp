...
{
    smpi->irecv( localfields->Ex_, recv_from_global_patch_rank, hindex*3  , patch->requests_[0] );
    smpi->irecv( localfields->Ey_, recv_from_global_patch_rank, hindex*3+1, patch->requests_[1] );
    smpi->irecv( localfields->Ez_, recv_from_global_patch_rank, hindex*3+2, patch->requests_[2] );
   

    smpi->irecv( localfields->Bx_m, recv_from_global_patch_rank, hindex*3  , patch->requests_[0] );
    smpi->irecv( localfields->By_m, recv_from_global_patch_rank, hindex*3+1, patch->requests_[1] );
    smpi->irecv( localfields->Bz_m, recv_from_global_patch_rank, hindex*3+2, patch->requests_[2] );
