...
t0 = l0                       # optical cicle
Lsim = [10.*l0,10.*l0,4.*l0]  # length of the simulation
...
LaserOffset(
    box_side = "zmin",
    space_time_profile = [None, lambda x,y,t: exp( -(20.*(x-offset_x)/Lsim[0])**2-(20.*(y-offset_y)/Lsim[1])**2 - (3.*(t-30.)/Tsim)**2 ) * sin(t)],
    offset = 4.,
