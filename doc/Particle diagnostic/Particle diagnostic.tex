...
First, run python and include the script: \code{python -i scripts/ParticleDiagnostic.py}\\*
Alternately, include this file into your own script: \code{execfile("scripts/ParticleDiagnostic.py")}
...
In our case, use
\begin{lstlisting}
>>> ParticleDiagnostic('tst1d_6_particle_diagnostic',3,slice={"ekin":"all"}).plot()
\end{lstlisting}
-- WORK IN PROGRESS --
