...
DOIs = [
"10.1038/s42005-024-01784-6",
"10.1038/s42005-024-01781-9",
"10.1088/1741-4326/ad6ce6",
"10.1103/PhysRevLett.133.125001",
"10.1103/PhysRevE.110.035202",
"10.1103/PhysRevE.110.035205",
"10.1063/5.0212163",
"10.1063/5.0191366",
"10.1051/0004-6361/202449661",
"10.1088/1361-6587/ad5379",
"10.1103/PhysRevResearch.6.L032052",
"10.1063/5.0205253",
"10.3390/app14146101",
"10.1063/5.0209316",
"10.1103/PhysRevA.110.013514",
"10.1063/5.0213592",
"10.3847/1538-4357/ad5181",
"10.1088/1612-202X/ad4bb8",
"10.1088/1402-4896/ad4fe7",
"10.3847/2041-8213/ad47b5",
"10.1103/PhysRevAccelBeams.27.051301",
"10.1103/PhysRevResearch.6.L032013",
"10.1103/PhysRevAccelBeams.27.063401",
"10.3847/2041-8213/ad3449",
...
for doi in DOIs:
    ...
    key = a["author"][0]["family"].replace(" ","") + year
    
    for A in a["author"]:
        A["given_short"] = " ".join( n[0] + "." for n in A["given"].split() )
    
    authors = ", ".join([A["given_short"]+" "+A["family"] for A in a["author"][:-1]]) + " and " + a["author"][-1]["given"]+" "+a["author"][-1]["family"]
    title = a["title"]
