...
.. code-block:: bash
  ...
  make config="scalasca"             : to compile using and for scalasca (required the Scalasca profiler)
...
.. code-block:: bash
  ...
  make config="detailed_timers"      : to compile using and for scalasca (required the Scalasca profiler)
