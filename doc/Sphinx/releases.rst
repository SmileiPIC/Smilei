...
This page lists the major changes in the successive versions.
Tarball are provided and can be directly downloaded.
However, :red:`it is strongly recommended to clone the latest version of Smilei from` `GitHub <https://github.com/SmileiPIC/Smilei>`_:

.. code ::

  git clone https://github.com/SmileiPIC/Smilei.git

*For those who are interested in a tutorial on Git, check* `here <https://git-scm.com/doc>`_.
...
* Changed radiation tables: see :doc:`radiation_loss`. 
  :red:`Old tables are not valid anymore, and input files using QED processes need to be updated.`

 * Default tables are now embebded in the code
 * Possibility to read external tables
 * tables generated by an :doc:`external tool <tables>` (more efficient and stable)

* New ``RadiationSpectrum`` diagnostics available, for details see :doc:`radiation_loss`.
