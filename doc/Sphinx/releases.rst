...
* Bug fixes:
  ...
  * New management of the physical tables: default tables for nonlinear inverse Compton Scattering and multiphoton Breit-Wheeler are now  embebded in the code for conveniency. Nonetheless the possibility to read external tables is kept.
